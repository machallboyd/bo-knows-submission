  ...
  function(request, sender, sendResponse) {
    chrome.tabs.query({ currentWindow: true, active: true }, function(tabs) {
      ...
      if( request.message === "open_bo_tab" ) {
        chrome.tabs.create({"url": "https://www.bo-ne.ws/submit", "index": index + 1}, function (tab) {
          chrome.tabs.executeScript(tab.id, {file:"jquery-3.2.1.min.js"}, function() {
            chrome.tabs.executeScript(tab.id, {file:"boform.js", runAt: "document_idle"}, function() {
